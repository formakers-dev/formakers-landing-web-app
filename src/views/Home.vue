  ...
  <div>
      ...
      <div>
        <div class="captionContainer">
          ...
          <div class="captionBody">
            게이머의 마음을 정확히 알고 싶다면, 직접 물어봐야 합니다.
          </div>
          <section>
            <div class="buttons">
    ...
    <div class="majorGameSubContainer">
      <div class="majorGameSubBox">
        ...
        <p class="majorGameSubBody">
          포메이커스, 너무 만족했습니다.<br />
          게임에 대한 퀄리티 좋은 유저 피드백을 받아 게임을 개선하고 싶다면
          추천드려요!!
        </p>
      ...
      <div class="majorGameSubBox">
        ...
        <p class="majorGameSubTitle" style="color: #EDAE30">
          원더스쿼드 서관희 대표님
        </p>
        <p class="majorGameSubBody">
          솔직하고 정성스럽게 써주신 분들이 많아서 <br />
          단지 게임 평점에서는 알 수 없었던 속마음과 좋은 의견들을 들을 수
          있어서 좋았습니다.
        </p>
      ...
      <div class="majorGameSubBox">
        ...
        <p class="majorGameSubTitle" style="color: #EE8292">
          자밥 스튜디오 권대현 대표님
        </p>
        <p class="majorGameSubBody">
          스토어 리뷰나 지인 평가는 참고만 해야지, <br />
          믿을게 못됩니다. 이 서비스를 통해 내 게임의 반응을 적나라하게 파악할
          수 있었습니다.
        </p>
    ...
    <div class="backgroundDiv two">
      ...
      <div>
        <div class="aboutContainer">
          ...
          <div class="eveImgBox">
            <img src="../assets/images/eve_img.png" alt="" />
          </div>
          <div class="aboutHeader">
            " 사용자 의견은 점점 중요해지는데, <br />왜 듣는 방법은 여전히
            원시적일까요? "
          </div>
          <div class="aboutBody">
            저는 전세계 사용자를 대상으로 제품을 만들던 UX 전문가였습니다.
            <br />매년 개발 툴이 쏟아져도 사용자 의견 수집 방법은 늘
            똑같았습니다. <br />
          ...
          <div class="aboutBody">
            사용자 의견을 더 합리적으로 들을 수 있어야 한다고 생각했습니다.
            <br />작은 기업의 위험성을 줄여주고, 큰 기업의 리소스를 아껴주고
            싶었습니다. <br />이 사업을 통해 기업들이 본질에 집중할 수 있게 돕고
            싶습니다.
          </div>
          <div class="aboutBody">- 포메이커스 대표 이보림 올림-</div>
        </div>
      </div>
    </div>
    <div class="contentBox">
    ...
    <div class="advantageContainer">
      <div class="advantageBox1">
        ...
        <p class="advantageBody">
          단순 알바가 아닌, 게임을 정말 좋아하는 <br />
          실제 게이머들이 테스터로 활동하고 있습니다.
        </p>
        <div class="divisionLine"></div>
      </div>
      <div class="advantageBox2">
        ...
        <p class="advantageBody">
          대형 퍼블리셔 부터 인디 게임사까지. <br />
          다양한 고객들이 포메이커스를 사용하고 계십니다.
        </p>
        <div class="divisionLine"></div>
      </div>
    </div>
...
// 백그라운드 배경
.one {
  background-image: url("../assets/images/home_back1.png");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center center;
}
.two {
  background-image: url("../assets/images/home_back2.jpg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center center;
  display: block;
...
.three {
  background-image: url("../assets/images/home_back4.jpg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center center;
  display: block;
