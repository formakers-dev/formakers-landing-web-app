<template>
  <div class="background">
    ...
    <div>
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제1조(목적)</span>
        <span class="policySubContent"
          >이 약관은 포메이커스(전자상거래 사업자)가 운영하는 포메이커스
          플랫폼(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
          “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및
          책임사항을 규정함을 목적으로 합니다.</span
        >
        <span class="policySubContent"
          >※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지
          않는 한 이 약관을 준용합니다.」</span
        >
      </div>
      <div class="policySubContainer">
        <span class="policySubTitle">제2조(정의)</span>
        <span class="policySubContent"
          >① “몰”이란 <span>포메이커스</span>가 재화 또는 용역(이하 “재화
          등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를
          이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며,
          아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</span
        >
        <span class="policySubContent"
          >② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를
          받는 회원 및 비회원을 말합니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle"
          >제3조 (약관 등의 명시와 설명 및 개정)</span
        >
        <span class="policySubContent"
          ...
          <span>포메이커스</span>의 초기 서비스화면(전면)에 게시합니다. 다만,
        ...
        <span class="policySubContent"
          ...
          관련 법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.</span
        >
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          관계법령 또는 상관례에 따릅니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제4조(서비스의 제공 및 변경)</span>
        <span class="policySubContent"
          >① “몰”은 다음과 같은 업무를 수행합니다.</span
        >
        <span class="policySubContent"
          >1. 재화 또는 용역에 대한 정보 제공 및 구매계약의 체결 <br />
          2. 구매계약이 체결된 재화 또는 용역의 배송 <br />
          3. 기타 “몰”이 정하는 업무</span
        >
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          이용자에게 통지 가능한 주소로 즉시 통지합니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제5조(서비스의 중단)</span>
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제6조(회원 가입)</span>
        <span class="policySubContent"
          >① 이용자는 “몰”이 정한 가입 양식에 따라 회원정보를 기입한 후 이
          약관에 동의한다는 의사표시를 함으로서 회원 가입을 신청합니다.</span
        >
        <span class="policySubContent"
          >② “몰”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각
          호에 해당하지 않는 한 회원으로 등록합니다.</span
        >
        <span class="policySubContent"
        ...
        >
        <span class="policySubContent"
          >③ 회원 가입계약의 성립 시기는 “몰”의 승낙이 회원에게 도달한 시점으로
          합니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제7조(회원 탈퇴 및 자격 상실 등) </span>
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          회원이 부담하는 채무를 기일에 지급하지 않는 경우 <br />
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제8조(회원에 대한 통지)</span>
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle"
          >제9조(구매신청 및 개인정보 제공 동의 등)</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제11조(지급방법)</span>
        <span class="policySubContent"
          >“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의
          방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에
          대하여 재화 등의 대금에 어떠한 명목의 수수료도추가하여 징수할 수
          없습니다.</span
        >
        <span class="policySubContent"
          >1. 폰뱅킹, 인터넷뱅킹, 메일 뱅킹 등의 각종 계좌 이체 <br />
          ...
          8. 기타 전자적 지급 방법에 의한 대금 지급 등</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle"
          >제12조(수신확인통지․구매신청 변경 및 취소)</span
        >
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          청약철회 등에 관한 규정에 따릅니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제13조(재화 등의 공급)</span>
        <span class="policySubContent"
          ...
          일부를 받은 날부터 3영업일 이내에 조치를 취합니다.이때 “몰”은 이용자가
        ...
        <span class="policySubContent"
          ...
          “몰”이 고의․과실이 없음을 입증한 경우에는 그러하지 아니합니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제14조(환급)</span>
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제15조(청약철회 등)</span>
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          날부터 30일 이내에 청약철회 등을 할 수 있습니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제16조(청약철회 등의 효과)</span>
        <span class="policySubContent"
          ...
          지연이자율을 곱하여 산정한 지연이자를 지급합니다.</span
        >
        <span class="policySubContent"
        ...
        <span class="policySubContent"
          ...
          청약철회 시 그 비용을누가 부담하는지를 이용자가 알기 쉽도록 명확하게
          표시합니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제17조(개인정보보호)</span>
        <span class="policySubContent"
          >① “몰”은 이용자의 개인정보 수집시 서비스제공을 위하여 필요한 범위에서
          최소한의 개인정보를 수집합니다.
        </span>
        <span class="policySubContent"
          >② “몰”은 회원 가입시 구매계약이행에 필요한 정보를 미리 수집하지
        ...
        <span class="policySubContent"
          ...
          다만, 관련 법령에 달리 정함이 있는 경우에는 예외로 합니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제18조(정보의 제공 및 광고의 게제)</span>
        <span class="policySubContent"
          >① “몰”은 서비스 이용 중 필요하다고 인정되는 다양한 마케팅 정보 등을
          전자우편이나 서신 우편, SMS, 전화, 알림 메시지(Push Notification),
          회원 연락처와 연동된 SNS 서비스 등의 방법으로 회원에게 제공할 수
          있으며, 회원은 이에 동의합니다. 이 경우, 회원의 통신환경 또는 요금구조
          등에 따라 회원이 데이터 요금 등을 부담할 수 있습니다.</span
        >
        <span class="policySubContent"
          >② 회원은 관련법에 따른 거래 관련 정보 및 고객 문의 등에 대한 답변
          등을 제외하고는 언제든지 전항의 전자우편 등에 대해서 수신 거절을 할 수
          있으며, 이 경우 “몰”은 즉시 전항의 마케팅 정보 등을 제공하는 행위를
          중단합니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제19조(“몰“의 의무)</span>
        <span class="policySubContent"
          >① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지
          않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화․용역을
          제공하는데 최선을 다하여야 합니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle"
          >제20조(회원의 ID 및 비밀번호에 대한 의무)</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        <span class="policySubTitle">제21조(이용자의 의무)</span>
        <span class="policySubContent"
          >이용자는 다음 행위를 하여서는 안 됩니다.</span
        >
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        ...
        <span class="policySubContent"
          ...
          그 거래에 대한 보증 책임을 지지 않습니다.</span
        >
      </div>

      <div class="policySubContainer">
        <span class="policySubTitle">제23조(저작권의 귀속 및 이용제한)</span>
        <span class="policySubContent"
      ...
      <div class="policySubContainer">
        ...
        >
        <span class="policySubContent"
          >부 칙(시행일) 이 약관은 2020년 4월 14일부터 시행합니다.</span
        >
      </div>
    </div>
  </div>
